...
public function firebase_login_session() {
  ...
  try {
   ...
   // MODIFIED: Clean the email to be case-insensitive and trim whitespace for robust comparison
   $email_for_query = trim(strtolower($email));
   // MODIFIED: Select `transaction_pin` instead of `pin` and alias it for the frontend.
