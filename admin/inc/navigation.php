        ...
        <nav class="mt-4">
         <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
                          <a href="<?php echo base_url ?>admin/?page=transaction" class="nav-link nav-index">
              <i class="far fa-circle nav-icon"></i>
              <p>Transactions</p>
             </a>
            </li>
            <li class="nav-item">
                          <a href="<?php echo base_url ?>admin/?page=transaction/deposit" class="nav-link nav-deposit">
              <i class="far fa-circle nav-icon"></i>
              <p>Deposit</p>
             </a>
            </li>
            <li class="nav-item">
                          <a href="<?php echo base_url ?>admin/?page=transaction/withdraw" class="nav-link nav-withdraw">
              <i class="far fa-circle nav-icon"></i>
              <p>Withdraw</p>
             </a>
            </li>
            <li class="nav-item">
                          <a href="<?php echo base_url ?>admin/?page=transaction/transfer" class="nav-link nav-transfer">
              <i class="far fa-circle nav-icon"></i>
              <p>Transfer</p>
             </a>
            </li>
