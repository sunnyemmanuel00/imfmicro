...
<script>
  $(document).ready(function(){
    ...
    // CORRECTED the URL to use a consistent, router-compatible format.
    $(document).on('click', '.view_data', function(){
      // Using .data() is a more robust way to get data attributes.
      const inquiryId = $(this).data('id');
      
      // This URL format is designed to work with your Admin smart router.
      const url = _base_url_ + "admin/?page=inquiries/view_inquiry&id=" + inquiryId;
      
      // CRITICAL DIAGNOSTIC: Log the URL to the console.
